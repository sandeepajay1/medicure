...
sh 'sudo scp -o StrictHostKeyChecking=no -i ./terraform_files/DEMOKEY.pem medicure-deployment.yml ubuntu@100.26.72.50:/home/ubuntu/'
sh 'sudo scp -o StrictHostKeyChecking=no -i ./terraform_files/DEMOKEY.pem medicure-service.yml ubuntu@100.26.72.50:/home/ubuntu/'
script{
try{
sh 'ssh -i ./terraform_files/DEMOKEY.pem ubuntu@100.26.72.50 kubectl apply -f .'
}catch(error)
{
sh 'ssh -i ./terraform_files/DEMOKEY.pem ubuntu@100.26.72.50 kubectl apply -f .'
}
